  ...
  >
    {rotationDirection === 1 ? "FORWARD" : "REVERSE"}
      ...
      <div className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-14 z-40">
        ...
        <div
  className="absolute top-32 sm:top-36 md:top-40 left-4 sm:left-24 md:left-48 lg:left-[19.2rem] right-4 sm:right-24 md:right-auto w-auto md:w-[60vw] lg:w-[54vw] h-[calc(100vh-180px)] sm:h-[calc(100vh-200px)] md:h-[calc(100vh-220px)] z-50"
>
  <DigitalTwinViewer2
    componentData={currentData}
    onComponentClick={handleComponentClick}
